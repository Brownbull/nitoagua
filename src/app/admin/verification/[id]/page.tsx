...
function getStatusBadge(status: string | null) {
  switch (status) {
    ...
    case "approved":
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-green-50 text-green-800 rounded-lg text-xs font-semibold whitespace-nowrap shrink-0">
    ...
    case "rejected":
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-red-50 text-red-800 rounded-lg text-xs font-semibold whitespace-nowrap shrink-0">
          Rechazado
        </span>
      );
    default:
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-gradient-to-r from-gray-200 to-white px-5 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl font-extrabold text-gray-900 truncate">{provider.name}</h1>
      ...
      <div className="p-6 space-y-3">
        {/* Personal Info */}
        <section className="bg-white rounded-xl p-3.5 shadow-sm" data-testid="personal-info-section">
        ...
        {/* Bank Info */}
        <section className="bg-white rounded-xl p-3.5 shadow-sm" data-testid="bank-info-section">
          <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">
        ...
        {/* Documents */}
        <section className="bg-white rounded-xl p-3.5 shadow-sm" data-testid="documents-section">
          <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">
        ...
        {/* Internal Notes */}
        <section className="bg-white rounded-xl p-3.5 shadow-sm" data-testid="notes-section">
          <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">
            Notas Internas
          </h2>
        ...
        {!canTakeAction && (
          <div className="bg-gray-100 rounded-xl p-3.5 text-center">
            ...
            <Link
              href="/admin/verification"
              className="inline-block mt-3 px-6 py-2 bg-gray-800 text-white rounded-lg text-sm font-semibold"
            >
              Volver a la Cola
            </Link>
          </div>
