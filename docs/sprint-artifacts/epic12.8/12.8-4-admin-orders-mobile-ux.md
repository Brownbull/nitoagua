...
- [ ] **Test 5: Desktop Layout Preserved**
  1. View orders page on desktop (≥ 768px)
...
- [ ] Status cards collapsible on mobile
- [ ] Header compact on mobile
- [ ] Filter dropdown text not cut off
- [ ] Efficient filter layout
- [ ] Order detail status prominent
